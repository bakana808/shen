...
class UserTable extends Table {
	 ...
	 */
	public constructor(sql) { super(sql);
	 ...
	 */
	public async addUser(name: string, dscr?: string): Promise<User> {
	 ...
	 * @returns {Promise<User>}
	 */
	async loadUser(tag): Promise<User> {
	...
	public async loadUsersByID(id: string): Promise<User>;
	public async loadUsersByID(ids: string[]): Promise<Users[]>;
	 ...
	 * @returns {Promise<User[]>}
	 */
	public async loadUsersByID(ids: string|string[]): Promise<User[]> {
	...
	async searchUsers(partial): Promise<User[]> {
		...
		return Promise.all(res.rows.map((row): User => new User(row)));
	}
	 ...
	 * @return {Promise<User>}
	 */
	async linkUser(id, options): Promise<User> {
	...
	async loadUserByLink(options): Promise<User?> {
